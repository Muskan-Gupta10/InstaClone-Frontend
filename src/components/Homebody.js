...
<div className='homecard' key={index}>
    ...
    borderRadius: "10px"}}>
      ...
      <Card.Img variant="top" height="300px" width="476px" src={item.image} />
      ...
      <Card.Text style={{fontSize:"1.3em",display:"inline",float:"right",position:"relative",bottom:"18px",top:'2px'}}>{`${(new Date()).getFullYear()}-${(new Date()).getMonth()}-${(new Date()).getDate()}`} </Card.Text>
